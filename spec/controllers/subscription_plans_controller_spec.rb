...
RSpec.describe SubscriptionPlansController, type: :controller do
  ...
  # SubscriptionPlansController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested subscription_plan as @subscription_plan" do
      subscription_plan = SubscriptionPlan.create! valid_attributes
      get :show, params: {id: subscription_plan.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested subscription_plan as @subscription_plan" do
      subscription_plan = SubscriptionPlan.create! valid_attributes
      get :edit, params: {id: subscription_plan.to_param}, session: valid_session
      expect(assigns(:subscription_plan)).to eq(subscription_plan)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SubscriptionPlan" do
        expect {
          post :create, params: {subscription_plan: valid_attributes}, session: valid_session
      ...
      it "redirects to the created subscription_plan" do
        post :create, params: {subscription_plan: valid_attributes}, session: valid_session
        expect(response).to redirect_to(SubscriptionPlan.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved subscription_plan as @subscription_plan" do
        post :create, params: {subscription_plan: invalid_attributes}, session: valid_session
        expect(assigns(:subscription_plan)).to be_a_new(SubscriptionPlan)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested subscription_plan" do
        subscription_plan = SubscriptionPlan.create! valid_attributes
        put :update, params: {id: subscription_plan.to_param, subscription_plan: new_attributes}, session: valid_session
      ...
      it "assigns the requested subscription_plan as @subscription_plan" do
        subscription_plan = SubscriptionPlan.create! valid_attributes
        put :update, params: {id: subscription_plan.to_param, subscription_plan: valid_attributes}, session: valid_session
        expect(assigns(:subscription_plan)).to eq(subscription_plan)
      end
    ...
    context "with invalid params" do
      it "assigns the subscription_plan as @subscription_plan" do
        subscription_plan = SubscriptionPlan.create! valid_attributes
        put :update, params: {id: subscription_plan.to_param, subscription_plan: invalid_attributes}, session: valid_session
        expect(assigns(:subscription_plan)).to eq(subscription_plan)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested subscription_plan" do
      subscription_plan = SubscriptionPlan.create! valid_attributes
      expect {
        delete :destroy, params: {id: subscription_plan.to_param}, session: valid_session
      }.to change(SubscriptionPlan, :count).by(-1)
    end
