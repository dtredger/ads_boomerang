...
RSpec.describe CreativesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all creatives as @creatives" do
      ...
      expect(assigns(:creatives)).to eq([creative])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested creative as @creative" do
      creative = Creative.create! valid_attributes
      get :show, params: {id: creative.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested creative as @creative" do
      creative = Creative.create! valid_attributes
      get :edit, params: {id: creative.to_param}, session: valid_session
      expect(assigns(:creative)).to eq(creative)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Creative" do
        expect {
          post :create, params: {creative: valid_attributes}, session: valid_session
        }.to change(Creative, :count).by(1)
      end

      it "assigns a newly created creative as @creative" do
        post :create, params: {creative: valid_attributes}, session: valid_session
        expect(assigns(:creative)).to be_a(Creative)
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved creative as @creative" do
        post :create, params: {creative: invalid_attributes}, session: valid_session
        expect(assigns(:creative)).to be_a_new(Creative)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested creative" do
        creative = Creative.create! valid_attributes
        put :update, params: {id: creative.to_param, creative: new_attributes}, session: valid_session
        creative.reload
      ...
      it "assigns the requested creative as @creative" do
        creative = Creative.create! valid_attributes
        put :update, params: {id: creative.to_param, creative: valid_attributes}, session: valid_session
        expect(assigns(:creative)).to eq(creative)
      end
    ...
    context "with invalid params" do
      it "assigns the creative as @creative" do
        creative = Creative.create! valid_attributes
        put :update, params: {id: creative.to_param, creative: invalid_attributes}, session: valid_session
        expect(assigns(:creative)).to eq(creative)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested creative" do
      creative = Creative.create! valid_attributes
      expect {
        delete :destroy, params: {id: creative.to_param}, session: valid_session
      }.to change(Creative, :count).by(-1)
    end
