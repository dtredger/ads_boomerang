...
RSpec.describe AdvertisersController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested advertiser as @advertiser" do
      ...
      get :show, params: {id: advertiser.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested advertiser as @advertiser" do
      advertiser = Advertiser.create! valid_attributes
      get :edit, params: {id: advertiser.to_param}, session: valid_session
      expect(assigns(:advertiser)).to eq(advertiser)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Advertiser" do
        expect {
          post :create, params: {advertiser: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved advertiser as @advertiser" do
        post :create, params: {advertiser: invalid_attributes}, session: valid_session
        expect(assigns(:advertiser)).to be_a_new(Advertiser)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested advertiser" do
        advertiser = Advertiser.create! valid_attributes
        put :update, params: {id: advertiser.to_param, advertiser: new_attributes}, session: valid_session
        advertiser.reload
      ...
      it "assigns the requested advertiser as @advertiser" do
        advertiser = Advertiser.create! valid_attributes
        put :update, params: {id: advertiser.to_param, advertiser: valid_attributes}, session: valid_session
        expect(assigns(:advertiser)).to eq(advertiser)
      end
    ...
    context "with invalid params" do
      it "assigns the advertiser as @advertiser" do
        advertiser = Advertiser.create! valid_attributes
        put :update, params: {id: advertiser.to_param, advertiser: invalid_attributes}, session: valid_session
        expect(assigns(:advertiser)).to eq(advertiser)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested advertiser" do
      advertiser = Advertiser.create! valid_attributes
      expect {
        delete :destroy, params: {id: advertiser.to_param}, session: valid_session
      }.to change(Advertiser, :count).by(-1)
    end
